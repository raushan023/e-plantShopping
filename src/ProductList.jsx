...
function ProductList({ onHomeClick }) {
    ...
    const calculateTotalQuantity = () => cartItems?.length ? cartItems.reduce((acumulator, currentItem) => acumulator + currentItem.quantity, 0) : 0;
                    ...
                    {plantsArray.map((category, index) => ( // Loop through each category in plantsArray
                        <div key={index}> {/* Unique key for each category div */}
                            <div className='category-heading'>
                                <hr className='category-heading-line' />
                            ...
                            <div className="product-list"> {/* Container for the list of plant cards */}
                                {category.plants.map((plant, plantIndex) => ( // Loop through each plant in the current category
                                    <div className="product-card" key={plantIndex}> {/* Unique key for each plant card */}
                                        ...
                                        {cartItems.find(item => item.name === plant.name) ? <button
                                            className="product-button-disabled"
                                            disabled
                                        >
                                            Added to Cart
                                        </button> : <button
